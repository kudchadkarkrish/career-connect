  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Student Record" maxWidth="max-w-md">
      <div className="space-y-4">
        <div className="flex items-start space-x-3 p-3 bg-rose-50 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/50 rounded-xl text-rose-800 dark:text-rose-300">
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 pt-4 flex items-center justify-end space-x-3">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-rose-600 hover:bg-rose-700 rounded-lg shadow-sm shadow-rose-200 dark:shadow-none transition-colors cursor-pointer"
          >
            Delete Student
          </button>
        </div>
