  ...
  return (
    ...
    >
        ...
        <div className="flex items-center space-x-2">
          <div
            className={`w-7 h-7 rounded-lg flex items-center justify-center ${
              criterion.passed ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700'
            }`}
          >
            <Icon className="w-3.5 h-3.5" />
          </div>
          <span className="text-sm font-bold text-slate-800">{criterion.label}</span>
        </div>
        {criterion.passed ? (
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div>
          <p className="text-slate-500 mb-0.5">Student</p>
          <p className="font-semibold text-slate-900">{criterion.studentValue}</p>
        </div>
        <div>
          <p className="text-slate-500 mb-0.5">Required</p>
          <p className="font-semibold text-slate-900">{criterion.requirement}</p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center space-x-3">
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Eligibility Checker</h1>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5">
        <h2 className="text-sm font-bold text-slate-800 mb-4">Select Student &amp; Drive</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full text-sm rounded-lg border border-slate-300 px-3 py-2.5 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-200 bg-white transition-colors"
            >
        ...
        {bothSelected && (
          <div className="mt-4 pt-4 border-t border-slate-100 flex flex-wrap items-center gap-2 text-xs text-slate-600">
            ...
            <span className="font-semibold text-slate-700">{selectedDrive.companyName}</span>
          </div>
        )}
      </div>
      ...
      {result && (
        <div className="space-y-4">
          ...
          {/* Criterion breakdown */}
          <div>
            <h3 className="text-sm font-bold text-slate-700 mb-3">Eligibility Breakdown</h3>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              <div>
                <p className="text-slate-500">Min CGPA</p>
                <p className="font-semibold text-slate-900 mt-0.5">≥ {selectedDrive.minCGPA}</p>
              </div>
              <div>
                <p className="text-slate-500">Max Backlogs</p>
                <p className="font-semibold text-slate-900 mt-0.5">≤ {selectedDrive.maxBacklogs}</p>
              </div>
              <div>
                <p className="text-slate-500">Eligible Depts</p>
              ...
              <div>
                <p className="text-slate-500">Package (CTC)</p>
                <p className="font-semibold text-slate-900 mt-0.5">₹{selectedDrive.packageLPA} LPA</p>
              </div>
            </div>
